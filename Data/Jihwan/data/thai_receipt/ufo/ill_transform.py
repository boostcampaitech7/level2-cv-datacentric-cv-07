...
if __name__ == "__main__":
    # Load your JSON data
    with open('/data/ephemeral/home/Jihwan/data/thai_receipt/ufo/train_modified_thai.json', 'r', encoding='utf-8') as f:
    ...
    # Save updated JSON
    with open('/data/ephemeral/home/Jihwan/data/thai_receipt/ufo/train.json', 'w', encoding='utf-8') as f:
