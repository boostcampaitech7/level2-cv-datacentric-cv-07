...
def convert_to_UFO(dataset):
    ...
    for i in range(len(img_data)):
        ...
        repeating_symbol = ground_truth["repeating_symbol"]
        for j in range(len(repeating_symbol)):
            curr_reapeating_symbol_list = repeating_symbol[j]
            for k in range(len(curr_reapeating_symbol_list)):
                image_count += 1
                curr_repeating_symbol = curr_reapeating_symbol_list[k]
                curr_repeating_symbol_quad = curr_repeating_symbol["quad"]
                curr_image["words"][image_count] = {
                    "transcription": curr_repeating_symbol['text'],
                    "points":[ [curr_repeating_symbol_quad['x1'], curr_repeating_symbol_quad['y1']], 
                            [curr_repeating_symbol_quad['x2'], curr_repeating_symbol_quad['y2']], 
                            [curr_repeating_symbol_quad['x3'], curr_repeating_symbol_quad['y3']], 
                            [curr_repeating_symbol_quad['x4'], curr_repeating_symbol_quad['y4']] ]
                }
        curr_image["chars"] = {}
