...
class SceneTextDataset(Dataset):
    def __init__(self, root_dir,
                 ...
                 color_jitter=True,
                 normalize=True):
        self._lang_list = ['chinese', 'japanese', 'thai', 'cord']
    ...
    def _infer_dir(self, image_fnames):
        lang_indicator = image_fnames.split('_')[0]
        if lang_indicator == 'zh':
            ...
            raise ValueError
        return osp.join(self.root_dir, f'{lang}_receipt', 'img')
